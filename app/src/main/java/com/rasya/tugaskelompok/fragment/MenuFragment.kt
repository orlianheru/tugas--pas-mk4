...
import com.rasya.tugaskelompok.AdapterMenu
...
class MenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Initialize and set the adapter correctly
        val adapter = AdapterMenu(requireContext(), foodItems)  // Use the correct adapter class
